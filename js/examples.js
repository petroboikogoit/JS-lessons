...
//   { name: 'Смарагд', price: 2700, quantity: 3 },
...
// console.log(calcTotalPrice(stones, 'Діамант')); // 5200
// console.log(calcTotalPrice(stones, 'Смарагд')); // 8100
// console.log(calcTotalPrice(stones, 'Аканіт')); // Такого каменя не знайдено
